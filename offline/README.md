...
Bootstrap использует уже работающий Ansible без переустановки системного Python.
Если Ansible отсутствует, проверяет комплект и устанавливает недостающие Python 3.13,
Ansible из локальных wheels, Vagrant и VirtualBox.
Первую установку системных зависимостей выполняйте из обычного терминала:
веб-консоль не принимает пароль sudo. Для системных установщиков macOS запросит пароль администратора;
