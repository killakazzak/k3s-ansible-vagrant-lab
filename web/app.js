...
function setBusy(value){busy=value;$('cluster-select').disabled=value;$('new-cluster').disabled=value;document.querySelectorAll('[data-action]').forEach(b=>b.disabled=value)}
