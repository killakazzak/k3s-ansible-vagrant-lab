...
async function openPodDebug(pod,options={}){
 ...
 const session={id:result.id,cluster,closed:false,term:null,retainedHost:host};podDebugSession=session;stop.disabled=false;start.textContent='Подключено';
