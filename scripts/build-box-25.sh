...
python3 "$ROOT/scripts/prepare-iso.py" "$BENTO/os_pkrvars/ubuntu/ubuntu-24.04-${guest_arch}.pkrvars.hcl" "${K3S_LAB_CACHE_ROOT:-$HOME/.cache/k3s-lab}/iso" "$CACHE/local-iso.pkrvars.json"
cd "$BENTO"
